...
from steamship.experimental.tools.generate_image import GenerateImageTool
...
class DalleBot(PackageService):
    ...
    def __init__(self, **kwargs):
        ...
        self._known_tools = [
            GenerateImageTool(client=self.client)
        ]

    @classmethod
    def config_cls(cls) -> Type[Config]:
        """Return the Configuration class."""
        return DalleBotConfig
